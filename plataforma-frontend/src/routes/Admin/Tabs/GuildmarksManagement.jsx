...
import GuildmarksManagementContent
    from "../../../components/admin/GuildmarksManagementContent/GuildmarksManagementContent.jsx";

const GuildmarksManagement = () => {
    return (
        <div>
            <MenuNavbar/>
...
export default GuildmarksManagement