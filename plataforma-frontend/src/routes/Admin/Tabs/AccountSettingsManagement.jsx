...
import AccountSettingsManagementContent
    from "../../../components/admin/AccountSettingsManagementContent/AccountSettingsManagementContent.jsx";

const AccountSettingsManagement = () => {
    return (
        <div>
            <MenuNavbar/>
            ...
            <div className='h-screen bg-gray-900 p-2 flex'>
                ...
                <div className="bg-gray-900 w-full h-full overflow-auto p-12">
                    <AccountSettingsManagementContent/>
                </div>
            </div>
