...
public class GuildmarkNaoEncontradaException extends ExceptionDefaultAbstractClass implements IDefaultException {

    public GuildmarkNaoEncontradaException(String customMessage) {
