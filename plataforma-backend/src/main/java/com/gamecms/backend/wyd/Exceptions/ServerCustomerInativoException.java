...
public class ServerCustomerInativoException extends ExceptionDefaultAbstractClass implements IDefaultException {

    public ServerCustomerInativoException(String customMessage) {
