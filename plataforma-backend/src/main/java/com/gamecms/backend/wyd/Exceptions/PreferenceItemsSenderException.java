...
public class PreferenceItemsSenderException extends ExceptionDefaultAbstractClass implements IDefaultException {

    public PreferenceItemsSenderException(String customMessage) {
